...
class clientGUI( Toplevel ):
    ...
    def user_refresh( self ):
        self.frm_usr_list_color.delete( 0, END )
        self.frm_usr_list_name.delete( 0, END )
        self.frm_usr_list_xxx.delete( 0, END )
        for ( id, name ) in self.client.user.items():
            self.frm_usr_list_color.insert( id, Profile.Bgcolor[id] )
            self.frm_usr_list_name.insert( id, name )
